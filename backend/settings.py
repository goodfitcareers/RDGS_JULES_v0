...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+psycopg://postgres:postgres@localhost:5432/dataset_distiller_db"
    OPENAI_API_KEY: str = "your_openai_api_key_here"
    OPENAI_MODEL_NAME: str = "gpt-3.5-turbo-0125" # Or your preferred model
